...
lattice_constant_set_Fe =[3.4989,3.4919, 3.4888,3.4872,...
...
D0=1e15;%HZ
T=1400;
L_size=1e3; % test kmc steps, change it to your own, usually 1e6 may be a suitable value 
for num_ratio=6
    current_ratio=ratio(num_ratio,:);
    lattice_constant=lattice_constant_set_Fe(num_ratio);
%%   creating interstitial structure
    ...
    %% the standard coordinates ，make sure  this is same order as the ML trained one
